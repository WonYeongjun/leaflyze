...
def get_point_of_interest(image):
    ...
    sam = sam_model_registry["vit_h"](
        checkpoint="C:/Users/UserK/Desktop/sam_vit_h.pth"
    ).to(device)
    predictor = SamPredictor(sam)

    # Image.fromarray(cv2.cvtColor(masked_image, cv2.COLOR_BGR2RGB)).show()
...
if __name__ == "__main__":
    ...
    plt.tight_layout()
    plt.savefig("./output/image_comparison.png", dpi=300)
    plt.show()
