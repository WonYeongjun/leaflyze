...
# 입력 이미지 로드
input_image = cv2.imread('Ddong.jpg', 0)
...
# 매칭 결과를 이미지에 그리기
output_image = cv2.drawMatches(template, kp1, input_image, kp2, matches, None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
