...
# 이미지를 저장
save_path = "C:/Users/UserK/Desktop/cal_img/raw/raw_img.jpg"
cv2.imwrite(save_path, rotated_img)


# 2 왜곡보정
def undistort_image(
    image_path, camera_matrix, dist_coeffs, target_size=(640 * 3, 480 * 3)
):
    # 원본 이미지 로드
    ...
    undistorted_image = cv2.undistort(
        image_resized, camera_matrix, dist_coeffs, None, new_camera_matrix
    )
...
if __name__ == "__main__":
    ...
    camera_matrix = np.array(
        [
            [1.90296778e03, 0.00000000e00, 9.62538876e02],
            [0.00000000e00, 1.90259449e03, 6.99587164e02],
            [0.00000000e00, 0.00000000e00, 1.00000000e00],
        ]
    )

    dist_coeffs = np.array(
        [-0.00159553, 0.25363958, -0.00156397, 0.00185892, -0.41956662]
    )
    ...
    if original is not None and undistorted is not None:
        # 보정된 이미지 저장
        save_path = "C:/Users/UserK/Desktop/cal_img/cal/cal_img.jpg"
...
if ids is not None:
    ...
    if len(marker_centers_sorted) == 4:
        ...
        # 변환된 이미지 저장
        save_path = "C:/Users/UserK/Desktop/cal_img/fin/fin_cal_img.jpg"
